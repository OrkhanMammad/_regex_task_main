...
function confirm() {
    ...
    if (UserName == "") {
        ...
        document.getElementById('txtusername').innerHTML = "Username approved";
        ...
        if (PassWord == "") {
            ...
            document.getElementById('txtpassword').innerHTML = "Password approved";
            ...
            if (Mail == "") {
                ...
                document.getElementById('txtmail').innerHTML = "E-Mail approved";
                alert("Logged In")
